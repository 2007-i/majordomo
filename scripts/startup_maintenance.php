...
{
   $mysql_path = GetCmdMysql();
   
   echo ("Running: " . $mysql_path . " -u " . DB_USER . " -p" . DB_PASSWORD . " " . DB_NAME . " <" . $filename . "\n");
...
if ($full_backup)
{
   ...
   $mysqldump = GetCmdMysqlDump();
   
   exec($mysqldump . " --user=".DB_USER." --password=".DB_PASSWORD." --no-create-db --add-drop-table --databases ".DB_NAME.">". $target_dir . "/" . DB_NAME . ".sql");
