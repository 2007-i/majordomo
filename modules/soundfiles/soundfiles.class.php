...
class soundfiles extends module
{
   ...
   */
   function admin(&$out)
   {
      ...
      if ($this->mode == 'update')
      {
         ...
         {
            copy($file, ROOT.'asset/sound/' . strtolower($file_name));
            $out['OK'] = 1;
         }
      }
      ...
      {
         @unlink(ROOT . 'asset/sound/' . $file . ".mp3");
         $this->redirect("?");
      }
   ...
   */
   function install($data = '')
   {
      ...
      if (!is_dir(ROOT . "asset/sound"))
         mkdir(ROOT . "asset/sound", 0777);
