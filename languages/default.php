...
$welcomeText = 'Thank you for using MajorDoMo -- an open-source home automation platform. <br/><br/>';
$welcomeText .= 'Read more about it and join our community: <a href="<#LANG_WIKI_URL#>" target=_blank>Web-site</a>';
$welcomeText .= ' | <a href="<#LANG_WIKI_URL#>forum/" target=_blank>Forum</a>';
$welcomeText .= ' | <a href="https://www.facebook.com/SmartLivingRu" target=_blank>Facebook page</a> <br/>&nbsp;<br/>';
$welcomeText .= ' &nbsp;<br/><small>P.S. You can customize or delete this page using ';
$welcomeText .= '<a href="/admin.php?pd=&md=panel&inst=&action=layouts">Control Panel</a></small>';
